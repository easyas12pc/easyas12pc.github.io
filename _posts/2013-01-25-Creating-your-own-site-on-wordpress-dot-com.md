...
<p style="text-align: center;"><a href="({{ site.url }}/images/WP-Guide/guide-to-wp-wp-account-creation-page1.jpg)" target="_blank"><img title="Dashboard Appearance Themes" src="({{ site.url }}/images/WP-Guide/guide-to-wp-wp-account-creation-page1.jpg)" alt="Enter your details to begin the WordPress.com Account creation process. Click <strong>Sign up</strong> on the <strong>Basic</strong> option to create a free site." /></a></p>
